...
in malicious activity, such as botnet command and control, spamming, and phishing. In order to defeat security systems, 
malicious domain names are generated by algorithms. To detect domains which may be malicious, the app builds
